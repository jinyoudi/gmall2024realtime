...
public class DwsTradeProvinceOrderWindow extends BaseApp {
    ...
    public void hadle(StreamExecutionEnvironment env, DataStreamSource<String> kafkaStrDs) {
        ...
        //{"create_time":"2024-11-04 00:07:51","sku_num":"1","activity_rule_id":"1","split_original_amount":"6999.0000"
        //,"split_coupon_amount":"0.0","sku_id":"2","date_id":"2024-11-04","user_id":"5550","province_id":"29"
        // ,"activity_id":"1","sku_name":"xx","id":"29261","order_id":"20982","split_activity_amount":"500.0"
        // ,"split_total_amount":"6499.0","ts":1730736471}
        ...
        SingleOutputStreamOperator<TradeProvinceOrderBean> reduceDS = windowDS.reduce(
                new ReduceFunction<TradeProvinceOrderBean>() {
                    ...
                    public TradeProvinceOrderBean reduce(TradeProvinceOrderBean value1, TradeProvinceOrderBean value2) throws Exception {
                        value1.setOrderAmount(value1.getOrderAmount().add(value2.getOrderAmount())); //底层add之后新创建了一个对象 赋值给OrderAmount
                        value1.getOrderIdSet().addAll(value2.getOrderIdSet());   //没有创建新的集合对象
                        return value1;
                    }
                },
                new WindowFunction<TradeProvinceOrderBean, TradeProvinceOrderBean, String, TimeWindow>() {
                    ...
                    public void apply(String s, TimeWindow window, Iterable<TradeProvinceOrderBean> input, Collector<TradeProvinceOrderBean> out) throws Exception {
                        ...
                        orderBean.setOrderCount((long) orderBean.getOrderIdSet().size()); //需要转换成long
